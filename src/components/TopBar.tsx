...
export default function TopBar({ title }: { title: string }) {
  return (
    <div className="bg-gradient-to-r from-pink-500 to-rose-500 text-white px-4 pt-10 pb-4 rounded-b-3xl shadow-md flex items-center gap-4 mb-6 sticky top-0 z-40">
